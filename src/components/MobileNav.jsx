...
export default function MobileNav({ onOpenAbout, onOpenSettings, onOpenPlayback }) {
  ...
  const handleSettings = () => {
    setOpen(false);
    setTimeout(() => onOpenSettings?.(), 230);
  };

  const handlePlayback = () => {
    setOpen(false);
    setTimeout(() => onOpenPlayback?.(), 230);
  };
            ...
            <>
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto min-h-0">
                  {/* ABOUT + SETTINGS + PLAYBACK buttons */}
                  <div className="px-3 pt-4 pb-2 flex flex-col gap-2">
                    <motion.button
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 0 14px rgba(var(--hud-rgb),0.15), inset 0 1px 0 rgba(var(--hud-rgb),0.1)",
                        transition: "all 0.18s ease",
                      }}
                      onTouchStart={(e) => {
                        e.currentTarget.style.background =
                          "rgba(var(--hud-rgb),0.18)";
                      }}
                      onTouchEnd={(e) => {
                        e.currentTarget.style.background =
                          "rgba(var(--hud-rgb),0.08)";
                      }}
                    >
                      <span
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div
                          ...
                          style={{ color: "rgba(var(--hud-rgb),0.6)" }}
                        >
                          Themes &amp; alert rules
                        </div>
                      </div>
                    ...
                    <motion.button
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 0 14px rgba(255,136,0,0.12), inset 0 1px 0 rgba(255,136,0,0.1)",
                        transition: "all 0.18s ease",
                      }}
                      onTouchStart={(e) => {
                    ...
                    <motion.button
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 0 18px rgba(0,212,255,0.2), inset 0 1px 0 rgba(0,212,255,0.15)",
                        transition: "all 0.18s ease",
                      }}
                      onTouchStart={(e) => {
                        e.currentTarget.style.background =
                    ...
                    >
                      ...
                      <span className="text-cyan-300 text-base shrink-0 font-bold">
                        ›
                      </span>
                    </motion.button>
                  </div>
                  ...
                  <div className="px-3 pb-4 flex flex-col gap-1.5">
                    {NAV_ITEMS.map((item, i) => (
                      ...
                      >
                        ...
                        <span className="text-cyan-400 text-sm shrink-0">
                          ›
                        </span>
                      </motion.button>
                    ))}
